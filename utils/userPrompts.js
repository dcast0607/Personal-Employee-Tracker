...
const userPrompts = () => {
  ...
  const fetchDepartments = async () => {
    const departmentsData = await databaseQueries
      .fetchAllDepartments()
      .then((data) => {
        console.table(data);
        console.log("--------------------------------------------------------");
  ...
  const fetchRoles = async () => {
    const rolesData = await databaseQueries
      .fetchAllRoles()
      .then((data) => {
        console.table(data);
        console.log("--------------------------------------------------------");
  ...
  const fetchEmployees = async () => {
    const employeesData = await databaseQueries
      .fetchAllEmployees()
      .then((data) => {
        console.table(data);
        console.log("--------------------------------------------------------");
  ...
  const createDepartment = async (departmentName) => {
    if (departmentName) {
      const departmentData = await databaseQueries
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you add a department name!"
      );
  ...
  const createRole = async (title, salary, department_id) => {
    if (title && salary && department_id) {
      const roleData = await databaseQueries
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops you need to make you that you have added a title, salary, and department ID!"
      );
      createRolePrompts();
    }
  };
  ...
  const createRolePrompts = async () => {
    const createRoleData = await databaseQueries
      .fetchAllDepartments()
      .then((data) => {
        console.table(data);
      })
  ...
  const createEmployee = async (first_name, last_name, role_id, manager_id) => {
    if (first_name && last_name) {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "You must provide at least a first name and last name. Please try again."
      );
  ...
  const createEmployeePrompts = async () => {
    const createEmployeePromptData = await databaseQueries
        ...
        inquirer
          .prompt([
            ...
            },
            {
              ...
              name: "role_id",
              message:
                "Please enter the role ID of the employee:(If available, refer to the table above) ",
            },
            {
              type: "input",
              name: "manager_id",
              message:
                "Please enter the manager ID of the employee:(If available, refer to the table above) ",
            },
          ])
          .then((data) => {
            createEmployee(
  ...
  const updateExistingEmployeeRole = async (employee_id, role_id) => {
    if (employee_id && role_id) {
      const updateRole = await databaseQueries
        .updateExistingEmployeeRole(employee_id, role_id)
        .then((data) => {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you provide an employee ID and a new role ID."
      );
    }
  };
  ...
  const updateExistingEmployeeRolePrompts = async () => {
    const userData = await databaseQueries
      .fetchEmployeeAndRolesTables()
      .then((data) => {
        console.table(data);
      })
          ...
          .prompt([
            {
              ...
              name: "employeeID",
              message:
                "Please enter the employee ID of the employee that you wish to update:(Refer to the table above to retrieve the ID) ",
            },
            {
              type: "input",
  ...
  const updateManagerEmployeeRecord = async (employee_id, manager_id) => {
    if (employee_id && manager_id) {
      const updateManagerData = await databaseQueries
        .updateExistingEmployeeManager(employee_id, manager_id)
        .then(() => {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you provide an employee ID and a new manager ID."
      );
    }
  };
  ...
  const updateExistingEmployeeManagersPrompts = async () => {
    const employeeData = await databaseQueries
      .fetchEmployeeAndRolesTables()
      .then((data) => {
        console.table(data);
      })
          ...
          .prompt([
            {
              ...
              name: "employeeID",
              message:
                "Please enter the employee ID of the employee you wish to update:(Refer to the table above for details) ",
            },
            {
              type: "input",
              name: "managerID",
              message:
                "Please enter the new manager ID:(Refer to the table above for details) ",
            },
          ])
          .then((data) => {
  ...
  const fetchEmployeesByManager = async (manager_id) => {
    if (manager_id) {
      const employeeData = await databaseQueries
        .fetchAllEmployeesByManager(manager_id)
        .then((data) => {
          console.table(data);
          navMenu();
        })
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you provide a manager ID."
      );
          ...
          .prompt([
            {
              ...
              name: "managerID",
              message:
                "Please enter the ID of the manager for which you need us to pull data for:(Refer to the table above) ",
            },
          ])
          .then((data) => {
  ...
  const fetchEmployeesByDepartment = async (department_id) => {
    if (department_id) {
      const employeeData = await databaseQueries
        .fetchAllEmployeesByDepartment(department_id)
        .then((data) => {
          console.table(data);
          navMenu();
        })
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you provide a department ID."
      );
          ...
          .prompt([
            {
              ...
              name: "departmentID",
              message:
                "Please enter the department ID to fetch employee data:(Refer to table above for reference) ",
            },
          ])
          .then((data) => {
  ...
  const removeEntity = async (entity, entity_id) => {
    if (entity && entity_id) {
      const removeData = await databaseQueries
        .deleteDatabaseEntry(entity, entity_id)
        .then(() => {
          if (entity == "employee") {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Whoops, please make sure that you have selected an entity type and the ID for that entity!"
      );
      removeEntityPrompts();
    }
  };
          ...
          .prompt([
            {
              ...
              name: "employeeID",
              message:
                "Please enter the employee ID of the employee that you wish to remove:(Refer to the table above for reference) ",
            },
          ])
          .then((data) => {
          ...
          .prompt([
            {
              ...
              name: "departmentID",
              message:
                "Please enter the department ID of the department that you wish to remove:(Refer to the table above for reference) ",
            },
          ])
          .then((data) => {
      ...
      .prompt([
        {
          ...
          message:
            "Please select the entity type that you would like to remove from the database:",
          choices: [
            "Remove a user",
            "Remove a department",
            "Remove a role",
  ...
  const fetchBudgetByDepartment = async (department_id) => {
    ...
    let departmentName;
    let totalBudget = 0;
    const budgetData = await databaseQueries
      .fetchDepartmentBudget(department_id)
      .then((data) => {
        console.table(data);
      ...
      .then(() => {
        ...
        console.log(
          `Total Budget for Department "${departmentName}/${department_id}" is: ${totalBudget}.`
        );
        navMenu();
      })
      .catch((err) => {
          ...
          .prompt([
            {
              ...
              name: "departmentID",
              message:
                "Please enter a department ID to see it's budget:(Refer to the table above for reference) ",
            },
          ])
          .then((data) => {
      ...
      .then((userSelection) => {
        ...
        switch (userSelection.choice) {
          ...
          case "Update an Employee Role":
            updateExistingEmployeeRolePrompts();
            break;
          case "Update Employee Managers":
            updateExistingEmployeeManagersPrompts();
            break;
          ...
          case "View Department Budget":
            fetchBudgetByDepartmentPrompts();
            break;
          default:
            return quit();
        }
